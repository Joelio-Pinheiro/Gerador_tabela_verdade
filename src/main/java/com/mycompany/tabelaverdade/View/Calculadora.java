...
public class Calculadora extends javax.swing.JFrame {
    ...
    private void saveFormula(String formula) {
        try {
            controller.saveFormula(formula);
        } catch (Exception e) {
            Util.ERROR(e.getMessage());
        }
    }
    
    private void deleteFormula(String formula) {
        controller.deleteFormula(formula);
    }
    
    public static void loadFormulas() {
        controller.loadFormulas();
        FormulasSalvas.loadListModel();
    }
     //private void onSaveButtonClicked() {
     //   String formula = /* código para obter a fórmula da interface gráfica */;
     //   saveFormula(formula); // Chama o método que salva a fórmula
    //}
     
    static {
        loadFormulas(); // Carrega as fórmulas quando a classe é carregada
    }
    /**
    ...
    private void initComponents() {
        ...
        SavedFormulasButton.setBorder(null);
